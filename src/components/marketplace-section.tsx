...
const categories = [
  { icon: <ShoppingBag className="w-3.5 h-3.5" />, label: "Toko Online" },
  { icon: <Building2 className="w-3.5 h-3.5" />, label: "Profil Perusahaan" },
  { icon: <Megaphone className="w-3.5 h-3.5" />, label: "Landing Page UMKM" },
  { icon: <Palette className="w-3.5 h-3.5" />, label: "Portofolio Kreatif" },
];
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-array-custom)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wider mb-3 sm:mb-4">
            Katalog Website <span className="text-[#FFBA1F]">Instan</span> & Ekonomis
          </h2>
          <p className="font-[family-name:var(--font-khand-custom)] text-base sm:text-lg md:text-xl text-gray-500 max-w-2xl mx-auto">
            Solusi cepat dan hemat untuk bisnis yang ingin langsung tampil profesional di internet dalam waktu 1-3 hari.
          </p>
        </motion.div>
          ...
          <div className="relative rounded-2xl sm:rounded-3xl border-2 border-dashed border-violet-200 bg-white p-8 sm:p-10 md:p-14 lg:p-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-500 font-[family-name:var(--font-khand-custom)] text-sm sm:text-base md:text-lg max-w-md mx-auto mb-5 sm:mb-8 leading-relaxed">
                Kami sedang menyiapkan koleksi template website siap pakai. Dari Toko Online, Profil Perusahaan, hingga Landing Page UMKM.
              </p>
